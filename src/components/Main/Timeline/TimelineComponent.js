        ...
        <div className={styles.container}>
          <ul>
            ...
            <li>
              <div>
                <span></span>
                <div className={styles.title}>Jadavpur University</div>
                <div className={styles.info}>
                  Computer Science and Engineering
                </div>
                <div className={styles.type}>2018 - Present</div>
              </div>{" "}
              <span className={styles.number}>
                <span>2018</span>
              </span>
            ...
            <li>
              <div>
                ...
                <div className={styles.info}>All India Rank</div>
            ...
            <li>
              <span></span>
              <div>
                <div className={styles.title}>South Point High School</div>
            ...
            <li>
              ...
              <div>
                <div className={styles.title}>South Point High School</div>
                <div className={styles.info}>Madhyamik Examination</div>
